...
/* key matrix pins */
#define MATRIX_ROW_PINS { D0, D1, B3, B2, B1 }
#define MATRIX_COL_PINS { F6, F5, F4, B0, B7, D5, D2, D3, D7, B4, B5, B6, C6, C7 }
#define UNUSED_PINS
...
#ifdef VIAL_ENABLE
#define VIAL_KEYBOARD_UID {0x66, 0x98, 0x1F, 0x90, 0xFC, 0xED, 0xFD, 0x20}
