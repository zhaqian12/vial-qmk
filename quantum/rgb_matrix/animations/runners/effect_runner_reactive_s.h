...
#if defined RGB_MATRIX_EFFECT_CYCLE_MULTISPLASH \
|| defined RGB_MATRIX_EFFECT_CYCLE_REACTIVE_MULTICROSS \
|| defined RGB_MATRIX_EFFECT_CYCLE_REACTIVE_MULTINEXUS \
|| defined RGB_MATRIX_EFFECT_CYCLE_REACTIVE_MULTIWIDE
